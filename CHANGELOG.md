...
- Ignored other emoji, thread replies, malformed events, duplicate deliveries, bot-authored reactions, excluded channels, and targets that cannot be verified against the current workspace bot.
