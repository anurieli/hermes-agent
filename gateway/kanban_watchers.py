...
class GatewayKanbanWatchersMixin:
    ...
    async def _kanban_notifier_watcher(self, interval: float = 5.0) -> None:
        ...
        **Multi-board:** iterates every board discovered on disk per
        ...
        # This kill switch is the deployment-level override; upstream's
        # notifier_profile model below decides per-subscription ownership.
        try:
            ...
            try:
                ...
                for d in deliveries:
                    ...
                    for ev in d["events"]:
                        ...
                        # Decision cards route to the same thread as a plain
                        # send, so they carry the fully-built metadata.
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        while self._running:
            ...
            try:
                ...
                total_ready, unguarded_ready = 0, 0
                if not _kanban_dispatch_allowed():
                    ...
                    # Health telemetry (aggregate across boards). Counts, not a
                    # bare bool: dispatcher_stuck_message() needs the guarded
                    # vs unguarded split so guarded-only work stops tripping a
                    # false "dispatcher stuck" warning.
